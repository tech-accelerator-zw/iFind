...
@Tag(name = "Customer Controller", description = "Rest Controller for Customers")
public class CustomerController {
    ...
    public Response<CustomerResponseDto> getCustomerById(@PathVariable Long id) {
        ...
        return new Response<CustomerResponseDto>().buildSuccessResponse("FOUND", customer, HttpStatus.FOUND);
